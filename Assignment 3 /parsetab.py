...
_lr_productions = [
  ...
  ('global_facts -> facts exec_line','global_facts',2,'p_global_facts','A3_MGC.py',109),
  ('facts -> func_def facts','facts',2,'p_facts_func','A3_MGC.py',115),
  ('facts -> assign facts','facts',2,'p_facts_assign','A3_MGC.py',118),
  ('facts -> <empty>','facts',0,'p_facts_empty','A3_MGC.py',121),
  ('func_def -> FUNC ID_FUNC LBRACE params RBRACE ASSIGN stm END','func_def',8,'p_func_def','A3_MGC.py',125),
  ('params -> ID_FUNC COMMA params','params',3,'p_params_func','A3_MGC.py',133),
  ('params -> ID COMMA params','params',3,'p_params_func','A3_MGC.py',134),
  ('params -> ID_FUNC','params',1,'p_params_ID','A3_MGC.py',139),
  ('params -> ID','params',1,'p_params_ID','A3_MGC.py',140),
  ('assign -> VAL ID ASSIGN stm END','assign',5,'p_assign','A3_MGC.py',145),
  ('stm -> ID_FUNC LBRACE args RBRACE','stm',4,'p_id_func','A3_MGC.py',150),
  ('args -> ID_FUNC COMMA args','args',3,'p_args','A3_MGC.py',158),
  ('args -> stm COMMA args','args',3,'p_args','A3_MGC.py',159),
  ('args -> ID_FUNC','args',1,'p_args','A3_MGC.py',160),
  ('args -> stm','args',1,'p_args','A3_MGC.py',161),
  ('stm -> stm PLUS stm','stm',3,'p_stm_binop','A3_MGC.py',193),
  ('stm -> stm MINUS stm','stm',3,'p_stm_binop','A3_MGC.py',194),
  ('stm -> stm TIMES stm','stm',3,'p_stm_binop','A3_MGC.py',195),
  ('stm -> stm DIVIDE stm','stm',3,'p_stm_binop','A3_MGC.py',196),
  ('stm -> stm DOT stm','stm',3,'p_stm_binop','A3_MGC.py',197),
  ('stm -> stm LESSTHAN stm','stm',3,'p_stm_binop','A3_MGC.py',198),
  ('stm -> stm GREATERTHAN stm','stm',3,'p_stm_binop','A3_MGC.py',199),
  ('stm -> stm EQUAL stm','stm',3,'p_stm_binop','A3_MGC.py',200),
  ('stm -> stm AND stm','stm',3,'p_stm_binop','A3_MGC.py',201),
  ('stm -> stm OR stm','stm',3,'p_stm_binop','A3_MGC.py',202),
  ('stm -> STRING','stm',1,'p_stm_string','A3_MGC.py',206),
  ('stm -> NUMBER','stm',1,'p_stm_number','A3_MGC.py',209),
  ('stm -> TRUE','stm',1,'p_stm_bool','A3_MGC.py',213),
  ('stm -> FALSE','stm',1,'p_stm_bool','A3_MGC.py',214),
  ('stm -> NIL','stm',1,'p_stm_nil','A3_MGC.py',218),
  ('stm -> ID','stm',1,'p_stm_id','A3_MGC.py',221),
  ('stm -> LPAREN stm RPAREN','stm',3,'p_stm_group','A3_MGC.py',224),
  ('stm -> IF stm THEN stm ELSE stm END','stm',7,'p_stm_if','A3_MGC.py',227),
  ('stm -> LET facts IN stm END','stm',5,'p_stm_let','A3_MGC.py',230),
  ('stm -> MINUS stm','stm',2,'p_stm_uminus','A3_MGC.py',233),
  ('exec_line -> EXEC stm','exec_line',2,'p_exec_line','A3_MGC.py',237),
  ('empty -> <empty>','empty',0,'p_empty','A3_MGC.py',241),
]
